			...
			<div class="container my-5">
				...
				<table class="table">
					...
					<tbody>
						...
						$sql= "select * from kid_details where id = (select user_id from users where user_id = '$id'  )" ;
						...
						while(	$user_data = mysqli_fetch_assoc($result))
						{
							...
							<td>
								<a class='btn btn-danger' href='generatepdf.php?id=$user_data[kid_id] ' role='button'>Generate-pdf</a>
                            </td>
